...
// TODO: Tweak to handling to force horizontal axis for second attribute (i.e. reject two-attribute scatterplots)
          ...
          handleAttributeChange = function () {
            ...
            codapInterface.sendRequest({
              ...
              let attributeAxis = iNotification.values.axisOrientation;
                if(attributeName === 'Total Count of Medical Doctors' && attributeAxis === 'horizontal')
                  this.handleAccomplishment('AddDoctors')
                else if(attributeName === 'Internet Users' && attributeAxis === 'horizontal')
                  this.handleAccomplishment('AddInternetUsers')
              };
              }.bind(this));
          }.bind(this),
          ...
          handleLegendAttributeChange = function() {
            if((iNotification.values.type === 'DG.GraphModel') && (iNotification.values.attributeName === 'Urban Living'))
